...
const INFURA_PROJECT_ID = process.env.REACT_APP_INFURA_PROJECT_ID; // REACT_APP_INFURA_PROJECT_ID_MAINNET
...
const app: Record<SupportedChains, AppConfig> = {
  [ChainId.Rinkeby]: {
    ...
    subgraphApiUri: 'https://api.thegraph.com/subgraphs/name/det-joe/testnouns',
